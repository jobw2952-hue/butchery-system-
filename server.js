...
// IMPORTANT: Serve static files from current directory (where server.js is)
...
// Serve frontend - THIS IS THE KEY FIX
// Serve index.html from the root directory
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'index.html'));
});

// For any other route, also serve index.html (SPA support)
app.get('*', (req, res) => {
